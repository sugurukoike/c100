...
int main()
{
    ...
    while (sum <= 16)
    {
        ...
        if (cards_num[draw_num] == 11 || cards_num[draw_num] == 12 || cards_num[draw_num] == 13)
        {
            cards_num[draw_num] = 10;
        }
        if (cards_num[draw_num] == 1)
        {
            if (21 - sum >= 11)
            {
                cards_num[draw_num] = 11;
            }
        }
        sum += cards_num[draw_num];
        draw_num += 1;
